...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--run-dir", required=True, help="Walk-forward run directory containing tables/oos_trades.csv.")
    ...
    ap.add_argument("--no-save-quantile-paths", action="store_true", help="Disable quantile path output (tables/quantile_paths.csv).")
